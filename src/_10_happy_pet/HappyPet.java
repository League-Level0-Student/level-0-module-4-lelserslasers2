...
public class HappyPet {
	...
	public static void main(String[] args) {
		...
		// 7. REPEAT steps 3 - 6 enough times to make your pet happy!
			...
			int task = JOptionPane.showOptionDialog(null, "What do you want to do to make your pet happy?", "Happy Pet", 0, JOptionPane.INFORMATION_MESSAGE, null,
					new String[] { "food", "water", "take it ffor a walk" }, null);
	...
	static void food() {
		System.out.println("your pet will have energy after this");
		happinessLevel = happinessLevel + 2;
	}
	
	static void water() {
		System.out.println("your pet will pee after this");
		happinessLevel = happinessLevel + 2;
	}
	
	static void walk() {
		System.out.println("your pet will sleep after this");
